...
const frameTemplateSchema = z.object({
  ...
  footer_address_display: z.string().optional().nullable(),
  footer_show_address: z.boolean().optional(),
  ...
  footer_address_font_size: z.number().int().min(14).max(48).optional(),
  ...
  footer_address_text_color: z.string().optional().nullable(),
